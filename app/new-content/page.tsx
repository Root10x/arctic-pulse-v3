...
const inputMethods = [
  ...
  { id: "bulk", label: "CSV Upload", icon: Upload, desc: "Upload a CSV file" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Create New Article</h1>
          <p className="text-slate-500 text-sm mt-1">Draft your content in one place</p>
        </div>
        {draft && (
      ...
      {/* Input Methods and Draft Output */}
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 p-3 rounded-lg border text-left transition-all ${
                      method === m.id ? "border-slate-900 bg-slate-50" : "border-slate-200 hover:border-slate-300 hover:bg-slate-50"
                    }`}
                  >
              ...
              <>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Add any research notes, angles, or key points..."
                    rows={4}
        ...
        <div className="lg:col-span-3">
          {!draft && !isGenerating && (
            <div className="card p-8 h-full flex flex-col items-center justify-center text-center border-dashed">
              ...
              <p className="text-xs text-slate-300 mt-1">Fill in the details and click Create Draft</p>
            </div>
          )}
          {isGenerating && (
            <div className="card p-8 h-full flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-sm font-medium text-slate-700">Preparing your draft...</h3>
              ...
              <div className="border border-slate-200 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-1 bg-slate-100 rounded-md p-0.5">
                    <button
                      ...
                      className={`px-2 py-1 text-xs rounded ${
                        imageTab === "free" ? "bg-white shadow-sm text-slate-900" : "text-slate-500"
                      }`}
                    >
                      Free Images
                    </button>
                    <button
                      ...
                      className={`px-2 py-1 text-xs rounded ${
                        imageTab === "generated" ? "bg-white shadow-sm text-slate-900" : "text-slate-500"
                      }`}
                    >
                      Generated Images
                    </button>
                ...
                {imageTab === "free" && (
                  <div className="space-y-3">
                      ...
                      {freeStockImages.slice(0, 6).map((img) => (
                        <button
                          ...
                          className={`relative rounded-lg overflow-hidden border-2 transition-all ${
                            selectedImage === img.url ? "border-slate-900" : "border-transparent"
                          }`}
                        >
                    ...
                    <p className="text-xs text-slate-400">From Unsplash, Pexels, Pixabay — free to use</p>
                  </div>
                )}
                  ...
                  <div className="space-y-3">
                    {isGeneratingImage ? (
                      <div className="flex flex-col items-center justify-center py-8">
                        ...
                        <p className="text-sm text-slate-500">Generating images...</p>
                        <p className="text-xs text-slate-400 mt-1">Based on your article topic</p>
                      </div>
                      ...
                      <div className="text-center py-6">
                        ...
                        <button
                          ...
                          className="btn-secondary mt-3 flex items-center gap-2 mx-auto"
                        >
                          <ImageIcon className="w-4 h-4" />
                          Generate Images
                        </button>
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-2">
                          {generatedImages.map((img) => (
                            ...
                            >
                              <img src={img.thumbnail || img.url} alt="Generated" className="w-full h-24 object-cover" />
                              {selectedImage === img.url && (
                                <div className="absolute top-1 right-1 w-5 h-5 bg-slate-900 rounded-full flex items-center justify-center">
                                  <Check className="w-3 h-3 text-white" />
                                </div>
                ...
                {selectedImage && (
                  <div className="mt-3 p-2 bg-green-50 rounded-lg border border-green-200 flex items-center gap-2">
                    ...
                    <span className="text-xs text-green-700">Featured image selected</span>
                  </div>
                )}
              </div>
